...
function Admin() {
  ...
  const handleImageUpload = async (e) => {
    ...
    // Atualize a URL para o domínio do backend no Heroku
    await axios.post('https://seu-backend.herokuapp.com/api/upload', formData)
      .then(response => {
  ...
  const handleTextUpdate = async (e) => {
    ...
    // Atualize a URL para o domínio do backend no Heroku
    await axios.post('https://seu-backend.herokuapp.com/api/update-text', data)
      .then(response => {
